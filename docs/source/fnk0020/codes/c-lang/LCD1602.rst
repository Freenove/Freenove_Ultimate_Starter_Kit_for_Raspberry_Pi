...
.. note::
    ...
    **It is necessary to configure 12C and install Smbus first (see** :ref:`Chapter 7 ADC <ADC>` **for details)**

.. raw:: html

   <iframe style="display: block; margin: 0 auto;" height="421.875" width="750" src="https://www.youtube.com/embed/L1bgX2f4Yio" frameborder="0" allowfullscreen></iframe>
...
.. py:function:: lcdPutchar (int handle, uint8_t data) & lcdPuts (int handle, char *string) & lcdPrintf (int handle, char *message, …)
